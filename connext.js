...
module.exports = function(key, secret) {
  return {
    ...
    chargeCard: function(token, amount, chargebackDestination, tokenContractAddress, callback) {
      chargeCard(key, secret, token, amount, chargebackDestination, tokenContractAddress, callback);
    },
